# Discussion 14 - Friday, December 12

## Reminders
- Project 67 is due on **Friday, December 12th @11:59 PM**
- GFA Deadline **Friday, December 12th @11:59 PM**!
- Your **Final Exam** is on **Tuesday, December 16th @6:30 - 8:30 PM**
- Refer to the following for more information:
    - [**Final Exam Logistics**](https://piazza.com/class/mbjy6l6wnge4f2/post/992)
    - [**Final Exam Makeups**](https://piazza.com/class/mbjy6l6wnge4f2/post/1005)
        - If you have a university excused reason to miss the final, you **must** request a makeup by **December 12th** (That's today!)
...
#### 6. OpSem/Typechecking/Type Inference
...
##### From Fall 2025 Discussion 10

##### Using the rules given below, show `let x = read () in let y = read () in x && y`
...
##### From Spring 2025 Final Exam

##### Reduce the following lambda expression using *lazy evaluation*. Show every step.
```
(λc. a b (c a)) ((λa. c) (λc. (λa. b)))
```
<details>
  <summary>
...
Here are the project 5 type checking rules:
...
1. Based on the rules, should the following typecheck? 
